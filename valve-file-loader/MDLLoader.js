...
THREE.MDLLoader = function ( manager ) {
	...
	this._parser = THREE.MDLLoader.parse;

};

THREE.MDLLoader.prototype = Object.create( THREE.MDLLoader );
THREE.MDLLoader.prototype.constructor = THREE.MDLLoader;

THREE.MDLLoader.parse = function ( buffer, loadMipmaps ) {
